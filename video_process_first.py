...
DEFAULT_ACTIVITY = "robbery, stealing, pilferage, pilfering, filching, shoplifting, thievery. "
...
def model_interface_first(uploaded_video, activity = DEFAULT_ACTIVITY):
    ...
    if best_result["likely_label"] != "other":
        ...
        print(f"Маргинальная активность обнаружена с вероятностью {best_result['likely_probability']:.2f}% на этом сегменте. Сегмент сохранен как {segment_path}")
    else:
